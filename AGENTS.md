...
This project is indexed by GitNexus as **NeatEditor** (28 symbols, 21 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
